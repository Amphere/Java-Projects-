 ...
 *
 * Class/File Name: Project9_BankAcount
 *
 * Revision     Date                        Release Comment
 * --------  ----------  ------------------------------------------------------
 *   1.0     06/12/2015  Initial Release
 *
 *
 * File Description
 * ----------------
 ...
 *  Device                             Description
 * ---------  -----------------------------------------------------------------
 * Monitor    1. Valid and invalid deposit/withdrawal amounts from a
 *               "BankAccount" object initialized with "name" only
 *            2. Valid and invalid deposit/withdrawal amounts from a
 *               "BankAccount" object initialized with "name" and start balance
 *               only.
 *            3. Valid and invalid deposit/withdrawal amounts from a
 *               "BankAccount" object initialized with "name", start balance,
 *               and specific "transaction" fee.
 *            4. Various transfers of values from one "BankAccount" to another
 *               "BankAccount" object.
 *
 *
 * Class Methods
...
{	
	 ...
	 * Pre-Conditions
	 * --------------
	 * 1. The "account" reference is not "null"
	 *
	 *
	 * RETurn
	 *  Type
	...
	/**************************************************************************
	 * Method: transfer(BankAccount,BankAccount,double)
	 * 
	 * Method Description
	 * ------------------
	 * This static method attempts to withdraw the secified amount from the
	 * "source", "BankAccount" object, and if possible, deposits that amount
	 * or part thereof, to the "destination", "BankAccount" object.
	 * The trasfer is accomplished by invoking the "source" object's non-
	 * static data member, "transfer", which RETurns a "bool" value, "true",
	 ...
	 *     Type           Name                         Description
	 * ------------  ------------  --------------------------------------------
	 * BankAccount   source        Reference to the source "BankAccount" object
	 * BankAccount   destination   Reference to the destination object
	 * double        withdrawal    Amount of the withdrawal
	 *
	 *
	 * RETurn
